    ...
    <div className="relative min-h-screen bg-mesh-light overflow-hidden noise">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-20 sm:py-24">
        ...
        {isInitialLoad && !data ? (
          ...
          // Show info message when repository was already healthy
          <div className={`mb-6 sm:mb-8 stat-card p-6 sm:p-8 rounded-3xl border-l-4 border-green-500 transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-display text-lg sm:text-xl font-bold text-green-700 uppercase mb-1">Repository Healthy</h3>
                <p className="text-green-600 text-xs sm:text-sm">No test failures detected - all tests are already passing! ✨</p>
              </div>
            </div>
          </div>
        ) : null}
